...
trait InputSchema extends Schema with CustomTypes {
  ...
  class Inputs(tag: Tag) extends Table[InputEntity](tag, tableName) {
    ...
    def outputTxHash: Rep[Option[Transaction.Hash]] =
      column[Option[Transaction.Hash]]("output_tx_hash")
    def outputAmount: Rep[Option[U256]] =
      column[Option[U256]]("output_amount", O.SqlType("DECIMAL(80,0)")) //U256.MaxValue has 78 digits
