...
package object explorer {
  ...
  def foldFutures[A, B: ClassTag](seqA: AVector[A])(f: A => Future[B])(
      implicit executionContext: ExecutionContext): Future[AVector[B]] =
    seqA.fold(Future.successful(AVector.empty[B])) {
