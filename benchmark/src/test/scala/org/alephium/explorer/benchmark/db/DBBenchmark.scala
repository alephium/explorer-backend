...
@Measurement(iterations = 1, time = 60, timeUnit = TimeUnit.SECONDS) //runs this benchmark for x minutes
...
//
  ...
  @Benchmark
  def transactions_per_token_read_state_MultiColumnIndex(
      state: TransactionsPerTokenReadState_MultiColumnIndex): Unit = {
    val query =
      TokenQueries.listTokenTransactionsAction(
        token  = TokenId.unsafe(state.next),
        offset = 50,
        limit  = 1000
      )
  ...
  @Benchmark
  def transactions_per_token_read_state_TimestampIndex_ASC_Order(
      state: TransactionsPerTokenReadState_TimestampIndex_ASC_Order): Unit = {
    val query =
      TokenQueries.listTokenTransactionsAction(
        token  = TokenId.unsafe(state.next),
        offset = 50,
  ...
  @Benchmark
  def transactions_per_token_read_state_TimestampIndex_DESC_Order(
      state: TransactionsPerTokenReadState_TimestampIndex_DESC_Order): Unit = {
    val query =
      TokenQueries.listTokenTransactionsAction(
        token  = TokenId.unsafe(state.next),
        offset = 50,
